...
let
  ...
  url =
    "https://fw-download.ubnt.com/data/unifi-os-server/24e0-linux-x64-5.1.15-926621de-c9d7-48cd-8921-a0ff3eebd3f4.15-x64";
  ...
  binwalk = pkgs.binwalk.override {
    uefi-firmware-parser =
      pkgs.python3Packages.uefi-firmware-parser.overridePythonAttrs (old: {
...
in pkgs.stdenvNoCC.mkDerivation {
  ...
  nativeBuildInputs = [ binwalk ] ++ (with pkgs; [ coreutils findutils ]);
