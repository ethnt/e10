  ...
  perSystem = { pkgs, system, ... }: {
    devShells.default = pkgs.mkShell {
      inputsFrom =
        ...
        in
        map (shell: self.devShells.${system}.${shell}) shellNames;
      ...
      shellHook =
        ...
        ''
          ...
          ${setSopsValueToEnvironmentVariable "AWS_ACCESS_KEY_ID" "./secrets.json"}
          ${setSopsValueToEnvironmentVariable "AWS_SECRET_ACCESS_KEY" "./secrets.json"}
          ...
          ${setSopsValueToEnvironmentVariable "OPNSENSE_API_SECRET" "./secrets.json"}
