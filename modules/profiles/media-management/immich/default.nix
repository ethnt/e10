{ config, ... }: {
  sops = {
    ...
    templates."immich/config.json" = {
      content = builtins.toJSON {
        server = {
          externalDomain = "https://immich.e10.camp";
        };
        oauth = {
          autoLaunch = false;
          autoRegister = true;
          buttonText = "Login with Authelia";
          clientId = "DpimJHTYr-K1ba5dFHj6mlRPXxkQCTN3E3RGljCmVXlGs.AcDdWwG9sysfV~Bv3vq7Z1rEEm";
          ...
          mobileRedirectUri = "https://immich.e10.camp/api/oauth/mobile-redirect";
  ...
  services.postgresqlBackup.databases = [ config.services.immich.database.name ];
